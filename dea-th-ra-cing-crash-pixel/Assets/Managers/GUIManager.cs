...
public class GUIManager : MonoBehaviour {
	...
	public static void ShowADS()
	{
		...
		if (timeShowAds > 90 || !firstShowAdsAtBegin)
		{
			...
			timeShowAds = 0;
			#if UNITY_ANDROID
            using (AndroidJavaClass jc = new AndroidJavaClass("com.deathracing.crash.pixel.UnityPlayerNativeActivity"))
			{
	...
	{SoundEngine.play(SoundEngine.instance.click);
		...
		#if UNITY_ANDROID
    Application.OpenURL("market://details?id=com.deathracing.crash.pixel");
		#elif UNITY_WP8
		WP8Statics.RateApp("");
		#elif UNITY_IOS
    Application.OpenURL("https://itunes.apple.com/us/app/death-racing-crash-pixel/id980949159?ls=1&mt=8");	
