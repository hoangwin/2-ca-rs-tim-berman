...
//		Debug.Log (objectQueue.Count);
	...
	public void AddNewBlock () 
	{
        ...
        for (int n = 0; n < 4; n++)
        {
            ...
            treetemp.Rotate(0, 0, 0);
            
            if (n == 0 || n == 1)
            {
                treetemp.Translate(treePosLeft.position.x, 0.5f, n * f1 + 0, Space.World);
            }
            else
                treetemp.Translate(-treePosLeft.position.x, 0.5f, (n - 2)*f2+  0, Space.World);
