	...
	public static  void initSounds(Context theContext)
	{
	    ...
	    // mMediaPlayer = new MediaPlayer();	     
	     ...
	     try {
	    	 ...
	    	 mMediaPlayer[0] = MediaPlayer.create(FruitTap.context,R.raw.m_title);
	    	 mMediaPlayer[1] = MediaPlayer.create(FruitTap.context, R.raw.game_background);
