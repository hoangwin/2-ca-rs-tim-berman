...
public class StateLogo extends FruitTap implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
				if (SCREEN_HEIGHT > 700) {
					if (FruitTap.fontsmall_White == null)
						FruitTap.fontsmall_White = new BitmapFont("font/white_24.spr", true);
					if (FruitTap.fontsmall_Yellow == null)
						FruitTap.fontsmall_Yellow = new BitmapFont("font/yellow_24.spr", true);
					if (FruitTap.fontbig_White == null)
						FruitTap.fontbig_White = new BitmapFont("font/white_36.spr", true);
					if (FruitTap.fontbig_Yellow == null)
						FruitTap.fontbig_Yellow = new BitmapFont("font/yellow_36.spr", true);
				} else if (SCREEN_HEIGHT > 300) { 
					if (FruitTap.fontsmall_White == null)
						FruitTap.fontsmall_White = new BitmapFont("font/white_big_400x240.spr", true);
					if (FruitTap.fontsmall_Yellow == null)
						FruitTap.fontsmall_Yellow = new BitmapFont("font/yellow_big_400x240.spr", true);
					if (FruitTap.fontbig_White == null)
						FruitTap.fontbig_White = new BitmapFont("font/white_big_400x240.spr", true);
					if (FruitTap.fontbig_Yellow == null)
						FruitTap.fontbig_Yellow = new BitmapFont("font/yellow_big_400x240.spr", true);
				} 
				break;
			case 2:
				SoundManager.getInstance();
				SoundManager.initSounds(FruitTap.context);
			...
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = FruitTap.loadImageFromAsset("image/howtoplay.png");
				}
				break;
			...
			case 8://init all variable 
				...
				DEF.BUTTON_TIMER_BAR_X = fontsmall_Yellow.stringWidth("Score : 999999") + DEF.DIALOG_BUTTON_CONFIRM_W / 2;
		...
		case MESSAGE_PAINT:
			...
			FruitTap.mainPaint.setColor(Color.WHITE);
			FruitTap.mainPaint.setTextSize(20);
			matrix.reset();
