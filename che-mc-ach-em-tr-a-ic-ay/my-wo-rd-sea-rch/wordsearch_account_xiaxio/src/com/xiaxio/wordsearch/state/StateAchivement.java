...
public class StateAchivement extends WordSearchActivity
{
	...
	public static String[] achivementUnLockStringTitle ={"Played 1 Game","3500 Score","10600 Score","27100 Score","53000 Score","Top Score"};
	public static String[] achivementUnLockStringConstent ={"Passed First Game",
															"Score more than 3500",
															"Score more than 10600",
															"Score more than 27100",
															"Score more than 53000",
															"Score more than 100000"};
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			WordSearchActivity.mainCanvas.drawText("Achivement", WordSearchActivity.SCREEN_WIDTH / 2,(int)(120*WordSearchActivity.scaleY) ,WordSearchActivity.android_MenuFont);
			...
			for(int i = 0;i<6;i++)
			{
				...
				if(!achivementLock[i])
				{
					spriteAchivement.drawAFrame(mainCanvas, 2*i ,(int)( 80*scaleX), (int)(168*scaleY) + offset + i*space);
				}
				else
				{
					spriteAchivement.drawAFrame(mainCanvas, 1 + 2*i ,(int)( 80*scaleX),(int)(168*scaleY) + offset + i*space);
				}
