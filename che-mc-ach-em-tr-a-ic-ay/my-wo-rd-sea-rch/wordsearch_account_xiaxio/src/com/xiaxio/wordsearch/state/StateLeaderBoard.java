...
public class StateLeaderBoard extends WordSearchActivity
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			WordSearchActivity.mainCanvas.drawText("LEADER BOARD", WordSearchActivity.SCREEN_WIDTH / 2,(int)(220*WordSearchActivity.scaleY) ,WordSearchActivity.android_MenuFont);
			...
			mainCanvas.drawText( "POS", POS_X,(int)( Begin_Y +  (1 + 1.5)*textBoundsNormal.height()), android_MenuFont);
			mainCanvas.drawText( " Name ", NAME_X,(int)( Begin_Y +  (1 + 1.5)*textBoundsNormal.height()), android_MenuFont);
			mainCanvas.drawText( "Score",SCORE_X,(int)( Begin_Y +  (1 + 1.5)*textBoundsNormal.height()), android_MenuFont);
		
			android_FontSmall.setTextAlign(Align.LEFT);
			android_FontSmall.setColor(Color.WHITE);
			for(int i=0;i<topUserInfoName.length;i++)
			{
				mainCanvas.drawText(" "+(i +1), POS_X,(int)( Begin_Y +  (1 + (i +2)* 1.5)*textBoundsNormal.height()), android_FontSmall);
				mainCanvas.drawText( topUserInfoName[i], NAME_X,(int)( Begin_Y +  (1 +(i +2)* 1.5)*textBoundsNormal.height()), android_FontSmall);
				mainCanvas.drawText(" "+topUserInfoScore[i],SCORE_X,(int)( Begin_Y +  (1 + (i +2)*1.5)*textBoundsNormal.height()), android_FontSmall);
			}			
			
			mainCanvas.drawText("--------------------", POS_X,(int)( Begin_Y +  (1 + (5 +2)* 1.5)*textBoundsNormal.height()), android_MenuFont);
			android_FontSmall.setColor(Color.rgb(233,100,17));
			mainCanvas.drawText(" " + myRank, POS_X,(int)( Begin_Y +  (1 + (6 +2)* 1.5)*textBoundsNormal.height()), android_FontSmall);
			mainCanvas.drawText(myName, NAME_X,(int)( Begin_Y +  (1 +(6 +2)* 1.5)*textBoundsNormal.height()), android_FontSmall);
			mainCanvas.drawText(" " + myScore,SCORE_X,(int)( Begin_Y +  (1 + (6 +2)*1.5)*textBoundsNormal.height()), android_FontSmall);
