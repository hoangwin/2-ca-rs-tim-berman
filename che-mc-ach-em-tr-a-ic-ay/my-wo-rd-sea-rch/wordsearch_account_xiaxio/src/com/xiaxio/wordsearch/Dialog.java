...
public class Dialog
{
	...
	public static void drawDialog(Canvas c)
	{
		...
		case DIALOG_TYPE_CONFIRM:
			WordSearchActivity.mainCanvas.drawText("CONFIRM", WordSearchActivity.SCREEN_WIDTH / 2,  (int)(500*WordSearchActivity.scaleY) ,WordSearchActivity.android_MenuFont);
