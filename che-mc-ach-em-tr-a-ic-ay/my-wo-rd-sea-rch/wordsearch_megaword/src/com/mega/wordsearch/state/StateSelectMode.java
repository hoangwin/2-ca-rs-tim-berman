...
public class StateSelectMode extends WordSearchActivity
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			WordSearchActivity.mainCanvas.drawText("SELECT MODE", WordSearchActivity.SCREEN_WIDTH / 2,(int)(220*WordSearchActivity.scaleY) ,WordSearchActivity.android_MenuFont);
			...
			mainCanvas.drawText("EASY", MENU_BEGIN_X,  MENU_BEGIN_Y + textBounds.height()/2, android_MenuFont);
			...
			mainCanvas.drawText("NORMAL", MENU_BEGIN_X,  MENU_BEGIN_Y +MENU_ELEMENT_SPACE+ textBounds.height()/2, android_MenuFont);
			...
			mainCanvas.drawText("HARD", MENU_BEGIN_X,  MENU_BEGIN_Y + 2*MENU_ELEMENT_SPACE+ textBounds.height()/2, android_MenuFont);
