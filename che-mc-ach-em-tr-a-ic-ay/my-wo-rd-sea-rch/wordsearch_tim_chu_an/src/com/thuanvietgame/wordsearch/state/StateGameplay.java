...
public class StateGameplay extends WordSearchActivity {
	...
	public static void drawHUD(Canvas c) {
		...
		mainCanvas.drawText("" + getStringTimer((int)(mTimerCount/1000)), 10, spriteDPad.getFrameHeight(DEF.FRAME_TEXT_BAR)/2 + textBounds.height()/2, android_FontSmall);
		
		android_FontSmall.setTextAlign(Align.RIGHT);
		mainCanvas.drawText("ĐIỂM : " + Map.mStateScole, spriteDPad.getFrameWidth(DEF.FRAME_TEXT_BAR)-10, spriteDPad.getFrameHeight(DEF.FRAME_TEXT_BAR)/2 + textBounds.height()/2, android_FontSmall);
