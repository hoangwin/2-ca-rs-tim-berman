...
{	
	...
	public static synchronized void SendMessage(int type) {
		...
		case MESSAGE_PAINT:
			...
			WordSearchActivity.mainCanvas.drawText("THÔNG TIN", WordSearchActivity.SCREEN_WIDTH / 2,  (int)(500*WordSearchActivity.scaleY) ,WordSearchActivity.android_FontNormal);
			WordSearchActivity.android_FontNormal.setColor(Color.WHITE);
			WordSearchActivity.mainCanvas.drawText("NHÓM :", WordSearchActivity.SCREEN_WIDTH / 2,  (int)(600*WordSearchActivity.scaleY) ,WordSearchActivity.android_FontNormal);
			WordSearchActivity.mainCanvas.drawText("Mega Free Game", WordSearchActivity.SCREEN_WIDTH / 2,  (int)(700*WordSearchActivity.scaleY) ,WordSearchActivity.android_FontNormal);
