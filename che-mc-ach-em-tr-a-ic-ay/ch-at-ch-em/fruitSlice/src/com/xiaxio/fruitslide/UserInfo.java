...
public class UserInfo {
	...
	public static  String getUsername()
	{
		...
		Account[] accounts = AccountManager.get(FruitSlide.mainGameLib).getAccounts();
	...
	{		
		UserInfo.myUserInfo.score= GamePlay.mTopScore;
		 UserInfo.myUserInfo.userName = getUsername();
		//String url = "http://gamethuanviet.com/fruitcuttermaster/SetGetData.php?type=update&username=toanstt&Score=12&Level=31&Played=14&country=14a";
		String url = "http://gamethuanviet.com/fruitcuttermaster/SetGetData.php?type=update&";
	...
	{
		String url = "http://gamethuanviet.com/fruitcuttermaster/SetGetData.php?type=select&username=" + getUsername();
