package com.xiaxio.fruitslide.actor;
...
import com.xiaxio.fruitslide.state.MainMenuEffect;
...
public class Fish extends Actor
{
	...
	public static int DEFAULT_Y = FruitSlide.SCREEN_HEIGHT + 20;
	...
	public void update()     
	{
		...
		case STATE_LIVE:
			updateAngle();
			if(FruitSlide.isTouchDrapInRect(0,0, FruitSlide.SCREEN_WIDTH, FruitSlide.SCREEN_HEIGHT))
			{
				int sizelistDrap = GamePlay.arrayListPoint.size();
				if(sizelistDrap==1)
				{
					if (FruitSlide.isTouchDrapInRect(m_x - width/2, m_y - height/2, width, height)) 
					{					
						slideFish();
						//break;
					}
