...
import com.xiaxio.fruitslide.R;
...
public class SoundManager { 
	...
	private static Context mContext;
	 ...
	 public static int SOUND_BOOM = 3;
	 ...
	 public static int SOUND_SWORD = 10;
	 public static int SOUND_SWORD_FISH = 11;
	...
	public static  void initSounds(Context theContext)
	{
	    ...
	    // mMediaPlayer = new MediaPlayer();	     
	     ...
	     try {
	    	 ...
	    	 mMediaPlayer[0] = MediaPlayer.create(FruitSlide.context,R.raw.musicbg);
	    	 mMediaPlayer[1] = MediaPlayer.create(FruitSlide.context, R.raw.musicbg);
	...
	{	
		...
		mSoundPoolMap.put(SOUND_BOOM, mSoundPool.load(mContext, R.raw.boom, 1));
		...
		mSoundPoolMap.put(SOUND_SWORD, mSoundPool.load(mContext, R.raw.sword, 1));
		mSoundPoolMap.put(SOUND_SWORD_FISH, mSoundPool.load(mContext, R.raw.swordfish, 1));
