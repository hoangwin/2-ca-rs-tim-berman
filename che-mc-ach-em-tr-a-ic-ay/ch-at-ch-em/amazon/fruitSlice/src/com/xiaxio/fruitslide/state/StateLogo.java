...
public class StateLogo extends FruitSlide implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
					...
					if (FruitSlide.fontsmall_White == null)
						FruitSlide.fontsmall_White = new BitmapFont("font/white_24.spr", true);
			...
			case 2:
				...
				SoundManager.initSounds(FruitSlide.context);
			...
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = FruitSlide.loadImageFromAsset("image/howtoplay.png");
