package com.xiaxio.fruitslide.gameplay;
...
import com.xiaxio.fruitslide.actor.Fish;
...
public class GamePlay
{
	...
	{
		Fish.gravity = 1f*FruitSlide.scaleY;	
		...
		paintLine.setStrokeWidth((int)(8*FruitSlide.scaleX));
		preFrameDrap =0;
	...
	public static void Update()
	{
		...
		if (mCountLive >= 3) {
				...
				FruitSlide.changeState(FruitSlide.STATE_WINLOSE);
		}
	...
	{	
		...
		int _x = random.nextInt(FruitSlide.SCREEN_WIDTH*9/10);
		...
		fish.speedX = (int)(FruitSlide.SCREEN_WIDTH/2 - _x)/((FruitSlide.SCREEN_WIDTH/16)) + (random.nextInt((int)(10*FruitSlide.scaleX)) -(int)( 5*FruitSlide.scaleX)) ;
		fish.speedY = (int)(FruitSlide.SCREEN_HEIGHT/22*FruitSlide.nScaleY + random.nextInt(FruitSlide.SCREEN_HEIGHT/120)*FruitSlide.nScaleY);
