...
--
-- Table structure for table `fruitcuttermaster`
--

CREATE TABLE IF NOT EXISTS `fruitcuttermaster` (
...
INSERT INTO `fruitcuttermaster` (`UserName`, `Score`, `Level`, `Played`, `Country`) VALUES
('Hello', 1, 1, 1, 0),
('aa', 1, 1, 1, 1),
('toanstt', 0, 0, 0, 0),
('nmtoan91', 0, 0, 0, 0),
