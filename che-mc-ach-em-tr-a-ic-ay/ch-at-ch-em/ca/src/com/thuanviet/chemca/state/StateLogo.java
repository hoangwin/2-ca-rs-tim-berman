...
public class StateLogo extends ChemFish implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:
			...
			case 1:
					...
					if (ChemFish.fontsmall_White == null)
						ChemFish.fontsmall_White = new BitmapFont("font/white_24.spr", true);
			...
			case 2:
				...
				SoundManager.initSounds(ChemFish.context);
			...
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = ChemFish.loadImageFromAsset("image/howtoplay.png");
