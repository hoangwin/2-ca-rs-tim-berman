...
import com.thuanviet.chemca.UserInfo;
...
public class StateLeaderBoard extends ChemFish
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_UPDATE:		
			...
			if (isKeyReleased(KeyEvent.KEYCODE_BACK) || ChemFish.isTouchReleaseInRect(0, 0, DEF.BUTTON_CANCEL_CONFIRM_W,DEF.BUTTON_CANCEL_CONFIRM_H))
		...
		case MESSAGE_PAINT:
			...
			int NAME_X = (int)(300* scaleX);;
			int SCORE_X = (int)(800* scaleX);;
		...
		//	mainCanvas.drawText(" "+(UserInfo.myUserInfo.level),LEVEL_X,(int)( Begin_Y +  (1 + (6 +2)*1.5)*textBoundsNormal.height()), android_FontNormal);
			...
			if (ChemFish.isTouchDrapInRect(0, 0, DEF.BUTTON_CANCEL_CONFIRM_W, DEF.BUTTON_CANCEL_CONFIRM_H))
				spriteDPad.drawAFrame(ChemFish.mainCanvas, DEF.FRAME_CANCEL_HIGHTLIGHT, 0, 0);
			else
				spriteDPad.drawAFrame(ChemFish.mainCanvas, DEF.FRAME_CANCEL_NORMAL, 0, 0);
