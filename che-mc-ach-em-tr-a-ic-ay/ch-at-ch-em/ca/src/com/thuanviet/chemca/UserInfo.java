...
public class UserInfo {
	...
	public static  String getUsername()
	{
		...
		Account[] accounts = AccountManager.get(ChemFish.mainGameLib).getAccounts();
	...
	{
		String url = "http://caogia.byethost10.com/chemca/SetGetData.php?type=select&username=" + getUsername();
