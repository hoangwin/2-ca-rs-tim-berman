package com.thuanviet.chemca.actor;
...
import com.thuanviet.chemca.state.MainMenuEffect;
...
public class Fish extends Actor
{
	...
	public static int DEFAULT_Y = ChemFish.SCREEN_HEIGHT + 20;
	...
	public void update()     
	{
		...
		case STATE_LIVE:
			updateAngle();
			if(ChemFish.isTouchDrapInRect(0,0, ChemFish.SCREEN_WIDTH, ChemFish.SCREEN_HEIGHT))
			{
				int sizelistDrap = GamePlay.arrayListPoint.size();
				if(sizelistDrap==1)
				{
					if (ChemFish.isTouchDrapInRect(m_x - width/2, m_y - height/2, width, height)) 
					{					
						slideFish();
						//break;
					}
