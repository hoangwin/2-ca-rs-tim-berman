...
import com.xiaxio.fishslide.state.StateCreadit;
import com.xiaxio.fishslide.state.StateGameplay;
import com.xiaxio.fishslide.state.StateHint;
import com.xiaxio.fishslide.state.StateHowToPlay;
import com.xiaxio.fishslide.state.StateIngameMenu;
import com.xiaxio.fishslide.state.StateLeaderBoard;
import com.xiaxio.fishslide.state.StateLogo;
import com.xiaxio.fishslide.state.StateMainMenu;
import com.xiaxio.fishslide.state.StateSelectLevel;
...
public class FishSlide extends GameLib
{
	...
	public static FishSlide mainActivity;
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		String UID = "a1519d9e1e85c40";//gaogiagame 
	...
	{
		String username = FishSlide.mainActivity.getUsername();
		if(username == null)
			username = "User";
		else
