package com.xiaxio.fishslide.gameplay;
...
import com.xiaxio.fishslide.actor.Fish;
...
public class GamePlay
{
	...
	{
		Fish.gravity = 1f*FishSlide.scaleY;	
		...
		paintLine.setStrokeWidth((int)(8*FishSlide.scaleX));
		preFrameDrap =0;
	...
	{	
		...
		int _x = random.nextInt(FishSlide.SCREEN_WIDTH*9/10);
		...
		fish.speedX = (int)(FishSlide.SCREEN_WIDTH/2 - _x)/((FishSlide.SCREEN_WIDTH/16)) + (random.nextInt((int)(10*FishSlide.scaleX)) -(int)( 5*FishSlide.scaleX)) ;
		fish.speedY = (int)(FishSlide.SCREEN_HEIGHT/22*FishSlide.nScaleY + random.nextInt(FishSlide.SCREEN_HEIGHT/120)*FishSlide.nScaleY);
