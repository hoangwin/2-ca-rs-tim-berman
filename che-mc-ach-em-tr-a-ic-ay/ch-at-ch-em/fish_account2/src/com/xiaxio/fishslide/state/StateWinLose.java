...
import com.xiaxio.fishslide.GameViewThread;
...
public class StateWinLose extends FishSlide
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_CTOR:
			...
			FishSlide.mainActivity.saveGame();
			FishSlide.mLevelUnlock++;
		...
		case MESSAGE_UPDATE:
			if (frameCountCurrentState < 20)
				return;			
			if (FishSlide.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
			{	StateGameplay.mcurrentlevel = 1; 
				changeState(STATE_GAMEPLAY);
			}

			if (isKeyReleased(KeyEvent.KEYCODE_BACK) || FishSlide.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
				changeState(STATE_MAINMENU);
			
			if (FishSlide.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H)) {					
		...
		case MESSAGE_PAINT:
			...
			FishSlide.mainCanvas.drawBitmap(BitmapGameOver, matrix, FishSlide.mainPaint);
			...
			if (scale >= scaleMaster)
			{
				...
				{
					//mainCanvas.drawText( "LEADERBOARD",SCREEN_WIDTH/2, (int)(scaleY*480) , android_FontNormal);
				}
			}
			...
			if(frameCountCurrentState > 20)
			{
				if (!FishSlide.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
					spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_RETRY_NORMAL, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);
				else
					spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_RETRY_HIGHTLIGHT, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);
	
				if (!FishSlide.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
					spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_MAINMENU_NORMAL, DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2);
				else
					spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_MAINMENU_HIGHTLIGHT, DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2);
				
				if (!FishSlide.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
					spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_LEADERBOARD_NORMAL, DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3);
				else
					spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_LEADERBOARD_HIGHTLIGHT, DEF.WINLOSE_BUTTON_X3, DEF.WINLOSE_BUTTON_Y3);
			}
			break;
		case MESSAGE_DTOR:
			break;
