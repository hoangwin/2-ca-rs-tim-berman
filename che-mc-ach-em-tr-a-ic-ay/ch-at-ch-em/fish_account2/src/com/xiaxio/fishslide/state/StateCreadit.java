...
public class StateCreadit extends FishSlide implements IConstant 
{	
	//
	...
	public static synchronized void SendMessage(int type) {
		...
		case MESSAGE_CTOR:
			...
			break;
		case MESSAGE_UPDATE:
			if (isKeyReleased(KeyEvent.KEYCODE_BACK)|| FishSlide.isTouchReleaseInRect(cancelX, cancelY, DEF.BUTTON_CANCEL_CONFIRM_W, DEF.BUTTON_CANCEL_CONFIRM_H))
			{
		...
		case MESSAGE_PAINT:
			...
			if (FishSlide.isTouchDrapInRect(cancelX, cancelY, DEF.BUTTON_CANCEL_CONFIRM_W, DEF.BUTTON_CANCEL_CONFIRM_H))
				spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_CANCEL_HIGHTLIGHT, cancelX, cancelY);
			else
				spriteDPad.drawAFrame(FishSlide.mainCanvas, DEF.FRAME_CANCEL_NORMAL,cancelX,cancelY);
