...
public class StateLogo extends FishSlide implements IConstant
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_CTOR:
			...
			logoimage = Bitmap.createScaledBitmap(logoimage, (int)(logoimage.getWidth()*scaleX), (int)(logoimage.getHeight()*scaleY), true);
			loadingStep = 0;
		...
		case MESSAGE_UPDATE:
			...
			case 1:
					...
					if (FishSlide.fontsmall_White == null)
						FishSlide.fontsmall_White = new BitmapFont("font/white_24.spr", true);
			...
			case 2:
				...
				SoundManager.initSounds(FishSlide.context);
			...
			case 5:
				...
				if (StateHowToPlay.bitmapHowToplay == null) {
					StateHowToPlay.bitmapHowToplay = FishSlide.loadImageFromAsset("image/howtoplay.png");
