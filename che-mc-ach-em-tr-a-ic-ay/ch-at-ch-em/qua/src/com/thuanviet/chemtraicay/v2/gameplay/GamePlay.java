package com.thuanviet.chemtraicay.v2.gameplay;
...
public class GamePlay
{
	...
	{
		Fish.gravity = 1f*ChemFruit.scaleY;	
		...
		paintLine.setStrokeWidth((int)(8*ChemFruit.scaleX));
		preFrameDrap =0;
	...
	public static void Update()
	{
		...
		if (mCountLive >= 3) {
				...
				ChemFruit.changeState(ChemFruit.STATE_WINLOSE);
		}
	...
	{	
		...
		int _x = random.nextInt(ChemFruit.SCREEN_WIDTH*9/10);
		...
		fish.speedX = (int)(ChemFruit.SCREEN_WIDTH/2 - _x)/((ChemFruit.SCREEN_WIDTH/16)) + (random.nextInt((int)(10*ChemFruit.scaleX)) -(int)( 5*ChemFruit.scaleX)) ;
		fish.speedY = (int)(ChemFruit.SCREEN_HEIGHT/22*ChemFruit.nScaleY + random.nextInt(ChemFruit.SCREEN_HEIGHT/120)*ChemFruit.nScaleY);
