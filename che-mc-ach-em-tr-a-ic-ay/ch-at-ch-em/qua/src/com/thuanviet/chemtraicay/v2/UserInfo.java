...
public class UserInfo {
	...
	public static  String getUsername()
	{
		...
		Account[] accounts = AccountManager.get(ChemFruit.mainGameLib).getAccounts();
	...
	{		
		...
		//String url = "http://gamethuanviet.com/chemtraicay/SetGetData.php?type=update&username=toanstt&Score=12&Level=31&Played=14&country=14a";
		String url = "http://gamethuanviet.com/chemtraicay/SetGetData.php?type=update&";
	...
	{
		String url = "http://gamethuanviet.com/chemtraicay/SetGetData.php?type=select&username=" + getUsername();
