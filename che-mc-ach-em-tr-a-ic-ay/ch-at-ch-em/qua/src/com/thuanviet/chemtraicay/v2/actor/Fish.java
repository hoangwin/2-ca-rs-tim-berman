package com.thuanviet.chemtraicay.v2.actor;
...
import com.thuanviet.chemtraicay.v2.state.MainMenuEffect;
...
public class Fish extends Actor
{
	...
	public static int DEFAULT_Y = ChemFruit.SCREEN_HEIGHT + 20;
	...
	public void update()     
	{
		...
		case STATE_LIVE:
			updateAngle();
			if(ChemFruit.isTouchDrapInRect(0,0, ChemFruit.SCREEN_WIDTH, ChemFruit.SCREEN_HEIGHT))
			{
				int sizelistDrap = GamePlay.arrayListPoint.size();
				if(sizelistDrap==1)
				{
					if (ChemFruit.isTouchDrapInRect(m_x - width/2, m_y - height/2, width, height)) 
					{					
						slideFish();
						//break;
					}
