...
public class StateWinLose extends ChemFruit
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_CTOR:
			...
			ChemFruit.mainActivity.saveGame();
			ChemFruit.mLevelUnlock++;
		...
		case MESSAGE_UPDATE:
			if (frameCountCurrentState < 20)
				return;			
			if (ChemFruit.isTouchReleaseInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
		...
		case MESSAGE_PAINT:
			...
			ChemFruit.mainCanvas.drawBitmap(BitmapGameOver, matrix, ChemFruit.mainPaint);
			...
			if(frameCountCurrentState > 20)
			{
				if (!ChemFruit.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
					spriteDPad.drawAFrame(ChemFruit.mainCanvas, DEF.FRAME_RETRY_NORMAL, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);
				else
					spriteDPad.drawAFrame(ChemFruit.mainCanvas, DEF.FRAME_RETRY_HIGHTLIGHT, DEF.WINLOSE_BUTTON_X1, DEF.WINLOSE_BUTTON_Y1);
	
				if (!ChemFruit.isTouchDrapInRect(DEF.WINLOSE_BUTTON_X2, DEF.WINLOSE_BUTTON_Y2, DEF.DIALOG_BUTTON_CONFIRM_W, DEF.DIALOG_BUTTON_CONFIRM_H))
