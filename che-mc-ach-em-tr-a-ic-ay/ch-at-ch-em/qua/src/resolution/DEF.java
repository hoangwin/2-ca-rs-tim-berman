...
//	public static int offset = -100;
	...
	public static int HOWTOPLAY_BACKGROUND_W = ChemFruit.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = ChemFruit.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = ChemFruit.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_TITLE_X = ChemFruit.SCREEN_WIDTH/2; 
	...
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = ChemFruit.SCREEN_WIDTH/2; 
	...
	public static int SELECTLEVEL_BACKGROUND_W = ChemFruit.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = ChemFruit.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = ChemFruit.SCREEN_WIDTH/2; 
	...
	public static int WINLOSE_BACKGROUND_W = ChemFruit.SCREEN_WIDTH - 20;
	public static int WINLOSE_BACKGROUND_H = ChemFruit.SCREEN_HEIGHT - 20;
	public static int WINLOSE_BUTTON_W = 93;
	public static int WINLOSE_BUTTON_H = 93;	
	public static int WINLOSE_TITLE_X = ChemFruit.SCREEN_WIDTH/2; 
	public static int WINLOSE_TITLE_Y = WINLOSE_BACKGROUND_Y ;
	public static int WINLOSE_CONTENT_SPACE_H = 35;
	public static int WINLOSE_CONTENT_SPACE_W = 2*ChemFruit.SCREEN_WIDTH/5;
	public static int WINLOSE_CONTENT_X = ChemFruit.SCREEN_WIDTH/2; 
