...
public class StateLeaderBoard extends DauTruong100
{
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			StateGameplay.spriteUi.drawAFrame(DauTruong100.mainCanvas, 10,  0,(int)(120*DauTruong100.scaleY));
			DauTruong100.android_MenuFont.setColor(Color.WHITE);
			DauTruong100.mainCanvas.drawText("XẾP HẠNG", DauTruong100.SCREEN_WIDTH / 2,(int)(230*DauTruong100.scaleY) ,DauTruong100.android_MenuFont);
			 
			// back
			if (isTouchDrapInRect((int)(650*DauTruong100.scaleX), (int)(155*DauTruong100.scaleY), MENU_BACK_WIDTH, MENU_BACK_HEIGHT))
				StateGameplay.spriteUi.drawAFrame(DauTruong100.mainCanvas, 13,  (int)(650*DauTruong100.scaleX),(int)(155*DauTruong100.scaleY));
			else
				StateGameplay.spriteUi.drawAFrame(DauTruong100.mainCanvas, 12, (int)(650*DauTruong100.scaleX),(int)(155*DauTruong100.scaleY));
			//draw  
	...
	{		
		//String url = "http://caogia.byethost10.com/dautruong100/SetGetData.php?type=update&username=toanstt&Score=12&country=14a";
		String url = "http://caogia.byethost10.com/dautruong100/SetGetData.php?type=update&";
	...
	{
		String url = "http://caogia.byethost10.com/dautruong100/SetGetData.php?type=select&username=" + getUsername();
