...
import com.xiaxio.popstar.state.StateCreadit;
import com.xiaxio.popstar.state.StateGameplay;
import com.xiaxio.popstar.state.StateHint;
import com.xiaxio.popstar.state.StateHowToPlay;
import com.xiaxio.popstar.state.StateIngameMenu;
import com.xiaxio.popstar.state.StateLeaderBoard;
import com.xiaxio.popstar.state.StateLogo;
import com.xiaxio.popstar.state.StateMainMenu;
import com.xiaxio.popstar.state.StateSelectLevel;
import com.xiaxio.popstar.state.StateWinLose;
...
public class PopStar extends GameLib
{
	...
	public static PopStar mainActivity;
	...
	{
		String username = PopStar.mainActivity.getUsername();
		SharedPreferences settings = getSharedPreferences(SAVE_REF, 0);
		mLevelUnlock = settings.getInt(LEVEL_UNLOCK,0);
		if (username != null && username.length() > 1)
			PopStar.UserName = username;
		else
