...
import com.xiaxio.popstar.GameThread;
	...
	public static synchronized void SendMessage(int type)
	{
		...
		case MESSAGE_PAINT:
			...
			if (StateGameplay.gameMode == 0) {
				...
				mainCanvas.drawText("must get " + Map.scoreLevel[ StateGameplay.mcurrentlevel] +" score ", SCREEN_WIDTH / 2,  HINT_Y +  5*textBounds.height(), android_FontNormal);
