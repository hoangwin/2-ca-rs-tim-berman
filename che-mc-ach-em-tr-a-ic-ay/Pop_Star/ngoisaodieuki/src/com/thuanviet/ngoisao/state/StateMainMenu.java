...
public class StateMainMenu extends PopStar implements IConstant
{
	...
	public static String[] arrayMenuString = {"CHƠI GAME","CHẤM ĐIỂM","Sound:","THOÁT" };
		...
		case MESSAGE_UPDATE:
			...
			for (int i = 0; i < arrayMenu.length; i++) {
				...
				//		break;
					case MENU_RATING:
						try {
							Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=com.thuanviet.ngoisao");
