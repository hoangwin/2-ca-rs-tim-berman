...
public class DEF
{
	...
	public static int FRAME_TARGET = 35;
	public static int FRAME_POINT = 36;
...
//	public static int offset = -100;
	...
	public static int LABEL_LEVEL_X = (int)( 100*StateGameplay.scaleX); ; 
	public static int LABEL_LEVEL_Y = -1;
	
	public static int LABEL_SCORE_X = LABEL_LEVEL_X; 
	...
	public static int HOWTOPLAY_BACKGROUND_W = PopStar.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = PopStar.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = PopStar.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_BACKGROUND_X = PopStar.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_Y = PopStar.SCREEN_HEIGHT /6;
	public static int CREADIT_BACKGROUND_W = PopStar.SCREEN_WIDTH - 2 * PopStar.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_H = PopStar.SCREEN_HEIGHT - 2 * PopStar.SCREEN_HEIGHT / 8;
	
	public static int CREADIT_TITLE_X = PopStar.SCREEN_WIDTH/2; 
	...
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = PopStar.SCREEN_WIDTH/2; 
	...
	public static int SELECTLEVEL_BACKGROUND_W = PopStar.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = PopStar.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = PopStar.SCREEN_WIDTH/2; 
