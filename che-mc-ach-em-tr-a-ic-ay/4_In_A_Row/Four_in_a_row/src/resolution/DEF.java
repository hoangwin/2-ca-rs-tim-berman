...
//	public static int offset = -100;
	...
	public static int HOWTOPLAY_BACKGROUND_W = FourInALine.SCREEN_WIDTH ;
	public static int HOWTOPLAY_BACKGROUND_H = FourInALine.SCREEN_HEIGHT;
	public static int HOWTOPLAY_BUTTON_W = 93;
	public static int HOWTOPLAY_BUTTON_H = 93;	
	public static int HOWTOPLAY_TITLE_X = FourInALine.SCREEN_WIDTH/2; 
	...
	public static int CREADIT_BACKGROUND_X = FourInALine.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_Y = FourInALine.SCREEN_HEIGHT /6;
	public static int CREADIT_BACKGROUND_W = FourInALine.SCREEN_WIDTH - 2 * FourInALine.SCREEN_WIDTH / 20;
	public static int CREADIT_BACKGROUND_H = FourInALine.SCREEN_HEIGHT - 2 * FourInALine.SCREEN_HEIGHT / 8;
	
	public static int CREADIT_TITLE_X = FourInALine.SCREEN_WIDTH/2; 
	...
	//align OPTION SCREEN
	public static int OPTION_TITLE_X = FourInALine.SCREEN_WIDTH/2; 
	...
	public static int SELECTLEVEL_BACKGROUND_W = FourInALine.SCREEN_WIDTH - 20;
	public static int SELECTLEVEL_BACKGROUND_H = FourInALine.SCREEN_HEIGHT - 20;
	public static int SELECTLEVEL_TITLE_X = FourInALine.SCREEN_WIDTH/2; 
