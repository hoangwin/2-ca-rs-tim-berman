...
struct  X509Store_t1232  : public Object_t
{
	...
	X509Certificate2Collection_t1225 * ___list_2;
	...
	X509Store_t1038 * ___store_4;
};
struct X509Store_t1232_StaticFields{
	...
	Dictionary_2_t33 * ___U3CU3Ef__switchU24mapF_5;
};
