...
struct ThreadSafeDictionaryValueFactory_2_t939;
...
struct  ThreadSafeDictionary_2_t940  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t939 * ____valueFactory_1;
	...
	Dictionary_2_t2540 * ____dictionary_2;
};
