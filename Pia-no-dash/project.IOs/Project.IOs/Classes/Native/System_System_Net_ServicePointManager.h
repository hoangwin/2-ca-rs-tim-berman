...
struct ICertificatePolicy_t1160;
...
struct  ServicePointManager_t1145  : public Object_t
{
};
struct ServicePointManager_t1145_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1174 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1156 * ___server_cert_cb_9;
};
