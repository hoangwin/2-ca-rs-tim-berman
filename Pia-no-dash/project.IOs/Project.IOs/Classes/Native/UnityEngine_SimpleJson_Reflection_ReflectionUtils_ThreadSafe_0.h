...
struct  ThreadSafeDictionary_2_t936  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t935 * ____valueFactory_1;
	...
	Dictionary_2_t2530 * ____dictionary_2;
};
