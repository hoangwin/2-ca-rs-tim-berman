...
struct  ClientSessionInfo_t1065  : public Object_t
{
	...
	ByteU5BU5D_t169* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t169* ___masterSecret_5;
};
struct ClientSessionInfo_t1065_StaticFields{
